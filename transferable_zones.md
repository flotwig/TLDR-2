...
* `jo` via `amra.nic.gov.jo.`: [Click here to view zone data.](archives/jo/amra.nic.gov.jo.zone)
...
* `xn--mgbayh7gpa` via `amra.nic.gov.jo.`: [Click here to view zone data.](archives/xn--mgbayh7gpa/amra.nic.gov.jo.zone)

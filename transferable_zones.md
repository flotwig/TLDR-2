...
* `mg` via `dns-tld.ird.fr.`: [Click here to view zone data.](archives/mg/dns-tld.ird.fr.zone)
...
* `ne` via `ns.intnet.ne.`: [Click here to view zone data.](archives/ne/ns.intnet.ne.zone)

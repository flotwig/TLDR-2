...
* `gp` via `ns1.nic.gp.`: [Click here to view zone data.](archives/gp/ns1.nic.gp.zone)
...
* `xn--j1amh` via `dns.tci.net.ua.`: [Click here to view zone data.](archives/xn--j1amh/dns.tci.net.ua.zone)

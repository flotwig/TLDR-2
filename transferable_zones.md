...
* `ax` via `ns2.aland.net.`: [Click here to view zone data.](archives/ax/ns2.aland.net.zone)
...
* `cm` via `auth02.ns.uu.net.`: [Click here to view zone data.](archives/cm/auth02.ns.uu.net.zone)

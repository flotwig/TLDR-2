...
* `tr` via `ns42.nic.tr.`: [Click here to view zone data.](archives/tr/ns42.nic.tr.zone)
...
* `yandex` via `ns2.uniregistry.info.`: [Click here to view zone data.](archives/yandex/ns2.uniregistry.info.zone)

...
* `gf` via `ns1-gp.mediaserv.net.`: [Click here to view zone data.](archives/gf/ns1-gp.mediaserv.net.zone)
...
* `mq` via `ns1-gp.mediaserv.net.`: [Click here to view zone data.](archives/mq/ns1-gp.mediaserv.net.zone)

...
* `jo` via `jordan1st.nic.gov.jo.`: [Click here to view zone data.](archives/jo/jordan1st.nic.gov.jo.zone)
...
* `xn--mgbayh7gpa` via `jordan1st.nic.gov.jo.`: [Click here to view zone data.](archives/xn--mgbayh7gpa/jordan1st.nic.gov.jo.zone)

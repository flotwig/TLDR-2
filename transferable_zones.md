...
* `fk` via `ns1.horizon.net.fk.`: [Click here to view zone data.](archives/fk/ns1.horizon.net.fk.zone)
...
* `pk` via `root-s.pknic.pk.`: [Click here to view zone data.](archives/pk/root-s.pknic.pk.zone)
...
* `tg` via `tld.cafe.tg.`: [Click here to view zone data.](archives/tg/tld.cafe.tg.zone)
